...
export class Convert {
  public static toWelcome(json: string): korean {
    return cast(JSON.parse(json), r("Welcome"));
  }

  public static welcomeToJson(value: korean): string {
...
const typeMap: any = {
  Welcome: o(
    [
      ...
      { json: "egg_groups", js: "egg_groups", typ: a(r("Color")) },
      {
        ...
        js: "evolution_chain",
        typ: r("EvolutionChain"),
      },
      { json: "evolves_from_species", js: "evolves_from_species", typ: null },
      {
        json: "flavor_text_entries",
        js: "flavor_text_entries",
        typ: a(r("FlavorTextEntry")),
      },
      ...
      { json: "order", js: "order", typ: 0 },
      {
        ...
        js: "pal_park_encounters",
        typ: a(r("PalParkEncounter")),
      },
      {
        json: "pokedex_numbers",
        js: "pokedex_numbers",
        typ: a(r("PokedexNumber")),
      },
  ...
  EvolutionChain: o([{ json: "url", js: "url", typ: "" }], false),
  FlavorTextEntry: o(
    [
